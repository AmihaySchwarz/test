        ...
        this.state.selectedDivisionText, "save")
          .then(resp => { 
            this.setState({
              ...
              this.props.onSavePublishClick(this.state.selectedDivision, this.state.qnaActionHistory);
          });
    });
  }
          ...
          this.state.selectedDivisionText, "save")
            .then(result => {
              this.setState({
                ...
                this.props.onSaveClick(this.state.selectedDivision, this.state.qnaActionHistory);
            });
      });
    }
  }
